...
void main()
{
  ...
  temp1 += textureProjLod(tex4, coord.xyzw, u.x);
  temp1 += textureProjLod(tex5, coord.xyzw, u.x);
  
  temp += textureProjLod(tex0, coord.xy, u.x);
  temp += textureProjLod(tex0, coord.xyzw, u.x);
  temp += textureProjLod(tex1, coord.xyz, u.x);
  temp += textureProjLod(tex1, coord.xyzw, u.x);
  temp += textureProjLod(tex2, coord.xyzw, u.x);
  temp += textureProjLod(tex14[index], coord.xyz, u.x);
