...
void main()
{ 
  //test imageatomicimin
  coloru.x = imageAtomicMin(img0a, icoord.x, 3);
  //test imageatomicimin --image2DMSArray
  //imageAtomicMin(img10, icoord.xyz, 3,4);
  //test imageatomicumin
  coloru.y = imageAtomicMin(img0a, icoord.y, 4);
  //test imageatomicimin --image2DMSArray
  //color23 = imageAtomicMin(img11, icoord.xyz, 3,4);
